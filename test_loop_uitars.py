...
model = Qwen2VLForConditionalGeneration.from_pretrained(
    "/data1/models/UI-TARS-7B-SFT", torch_dtype="bfloat16", device_map="auto",attn_implementation="flash_attention_2"
)
processor = AutoProcessor.from_pretrained(
    "/data1/models/UI-TARS-7B-SFT", use_fast=True
)
base_data_path = "/data1/home/wuzheng/IFRAgent/Trajectories"
log_dir = "/data1/home/wuzheng/IFRAgent/Logs/main/TARS-SFT_IFRAgent"
#test_loop_IFRAgent(model, processor, data_path, log_dir, embedding_model, help_model, tokenizer)
#test_loop_tars(model, processor, data_path, log_dir)
run_all_tests(
